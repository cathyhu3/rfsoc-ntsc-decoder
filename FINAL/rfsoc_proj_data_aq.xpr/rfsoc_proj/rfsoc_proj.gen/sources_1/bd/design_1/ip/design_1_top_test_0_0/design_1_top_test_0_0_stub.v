...
// Date        : Mon Dec 15 16:44:48 2025
// Host        : eecs-digital-42 running 64-bit Ubuntu 24.04.3 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/thagenlo/Desktop/rfsoc_proj_data_aq.xpr/rfsoc_proj/rfsoc_proj.gen/sources_1/bd/design_1/ip/design_1_top_test_0_0/design_1_top_test_0_0_stub.v
...
module design_1_top_test_0_0(s00_axis_aclk, s00_axis_aresetn, 
  ...
  m00_axis_tlast, m00_axis_tready, MMIO_thresholds, adc_data_real, adc_data_imag, 
  cordic_data_magnitude, s_tready, s_tvalid, m_tready, m_tvalid, cordic_magnitude, 
  hsync_counter, past_hsync_trigger, vsync_trigger, hsync_trigger, in_hsync_range, 
  hsync_sample_counter, in_vsync_range, vsync_sample_counter, in_cb_range, 
  cb_sample_counter, cb_trigger, state)
/* synthesis syn_black_box black_box_pad_pin="s00_axis_aresetn,s00_axis_tready,s00_axis_tdata[31:0],s00_axis_tstrb[3:0],s00_axis_tlast,s00_axis_tvalid,m00_axis_aclk,m00_axis_aresetn,m00_axis_tvalid,m00_axis_tdata[31:0],m00_axis_tstrb[3:0],m00_axis_tlast,m00_axis_tready,MMIO_thresholds[95:0],adc_data_real[15:0],adc_data_imag[15:0],cordic_data_magnitude[15:0],s_tready,s_tvalid,m_tready,m_tvalid,cordic_magnitude[15:0],hsync_counter[4:0],past_hsync_trigger,vsync_trigger,hsync_trigger,in_hsync_range,hsync_sample_counter[7:0],in_vsync_range,vsync_sample_counter[7:0],in_cb_range,cb_sample_counter[7:0],cb_trigger,state[2:0]" */
/* synthesis syn_force_seq_prim="s00_axis_aclk" */;
  ...
  output [15:0]adc_data_real;
  output [15:0]adc_data_imag;
  output [15:0]cordic_data_magnitude;
  output s_tready;
  output s_tvalid;
  output m_tready;
  output m_tvalid;
  output [15:0]cordic_magnitude;
  output [4:0]hsync_counter;
  output past_hsync_trigger;
  output vsync_trigger;
  output hsync_trigger;
  output in_hsync_range;
  output [7:0]hsync_sample_counter;
  output in_vsync_range;
  output [7:0]vsync_sample_counter;
  output in_cb_range;
  output [7:0]cb_sample_counter;
  output cb_trigger;
  output [2:0]state;
endmodule
