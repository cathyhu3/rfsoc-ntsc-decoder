...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=17,numNonXlnxBlks=3,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_rf_converter_usp_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (adc2_clk_clk_n,
    adc2_clk_clk_p,
    sysref_in_diff_n,
  ...
  wire [31:0]iq_framer_0_M00_AXIS_TDATA;
  wire iq_framer_0_M00_AXIS_TLAST;
  wire iq_framer_0_M00_AXIS_TREADY;
  wire [3:0]iq_framer_0_M00_AXIS_TSTRB;
  wire iq_framer_0_M00_AXIS_TVALID;
  wire [95:0]mmio_interface_0_command;
  wire [0:0]proc_sys_reset_0_peripheral_aresetn;
  wire [0:0]proc_sys_reset_1_peripheral_aresetn;
  wire sysref_in_diff_n;
  wire sysref_in_diff_p;
  wire [31:0]top_test_0_M00_AXIS_TDATA;
  wire top_test_0_M00_AXIS_TLAST;
  wire top_test_0_M00_AXIS_TREADY;
  wire [3:0]top_test_0_M00_AXIS_TSTRB;
  wire top_test_0_M00_AXIS_TVALID;
  wire [15:0]top_test_0_adc_data_imag;
  wire [15:0]top_test_0_adc_data_real;
  wire [7:0]top_test_0_cb_sample_counter;
  wire top_test_0_cb_trigger;
  wire [15:0]top_test_0_cordic_data_magnitude;
  wire [15:0]top_test_0_cordic_magnitude;
  wire [4:0]top_test_0_hsync_counter;
  wire [7:0]top_test_0_hsync_sample_counter;
  wire top_test_0_hsync_trigger;
  wire top_test_0_in_cb_range;
  wire top_test_0_in_hsync_range;
  wire top_test_0_in_vsync_range;
  wire top_test_0_past_hsync_trigger;
  wire [2:0]top_test_0_state;
  wire [7:0]top_test_0_vsync_sample_counter;
  wire top_test_0_vsync_trigger;
  ...
  wire vin2_01_v_n;
  wire vin2_01_v_p;
  wire [95:0]xpm_cdc_gen_0_dest_out;
  ...
  design_1_axi_smc_0 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .S02_AXI_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARADDR),
        .S02_AXI_arburst(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARBURST),
        .S02_AXI_arcache(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARCACHE),
        .S02_AXI_arid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARID),
        .S02_AXI_arlen(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARLEN),
        .S02_AXI_arlock(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARLOCK),
        .S02_AXI_arprot(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARPROT),
        .S02_AXI_arqos(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARQOS),
        .S02_AXI_arready(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARREADY),
        .S02_AXI_arsize(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARSIZE),
        .S02_AXI_aruser(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARUSER),
        .S02_AXI_arvalid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARVALID),
        .S02_AXI_awaddr(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWADDR),
        .S02_AXI_awburst(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWBURST),
        .S02_AXI_awcache(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWCACHE),
        .S02_AXI_awid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWID),
        .S02_AXI_awlen(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWLEN),
        .S02_AXI_awlock(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWLOCK),
        .S02_AXI_awprot(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWPROT),
        .S02_AXI_awqos(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWQOS),
        .S02_AXI_awready(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWREADY),
        .S02_AXI_awsize(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWSIZE),
        .S02_AXI_awuser(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWUSER),
        .S02_AXI_awvalid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_AWVALID),
        .S02_AXI_bid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_BID),
        .S02_AXI_bready(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_BREADY),
        .S02_AXI_bresp(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_BRESP),
        .S02_AXI_bvalid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_BVALID),
        .S02_AXI_rdata(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_RDATA),
        .S02_AXI_rid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_RID),
        .S02_AXI_rlast(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_RLAST),
        .S02_AXI_rready(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_RREADY),
        .S02_AXI_rresp(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_RRESP),
        .S02_AXI_rvalid(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_RVALID),
        .S02_AXI_wdata(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_WDATA),
  ...
  design_1_axis_data_fifo_0_0 axis_data_fifo_0
       (.m_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_tdata(top_test_0_M00_AXIS_TDATA),
        .s_axis_tlast(top_test_0_M00_AXIS_TLAST),
        .s_axis_tready(top_test_0_M00_AXIS_TREADY),
        .s_axis_tstrb(top_test_0_M00_AXIS_TSTRB),
        .s_axis_tvalid(top_test_0_M00_AXIS_TVALID));
  ...
  design_1_ila_0_0 ila_0
       (.clk(clk_wiz_0_clk_out1),
        .probe0(top_test_0_adc_data_real),
        .probe1(top_test_0_adc_data_imag),
        .probe10(top_test_0_in_vsync_range),
        .probe11(top_test_0_vsync_sample_counter),
        .probe12(top_test_0_in_cb_range),
        .probe13(top_test_0_cb_sample_counter),
        .probe14(top_test_0_cb_trigger),
        .probe15(top_test_0_state),
        .probe2(top_test_0_cordic_data_magnitude),
        .probe3(top_test_0_cordic_magnitude),
        .probe4(top_test_0_hsync_counter),
        .probe5(top_test_0_past_hsync_trigger),
        .probe6(top_test_0_vsync_trigger),
        .probe7(top_test_0_hsync_trigger),
        .probe8(top_test_0_in_hsync_range),
        .probe9(top_test_0_hsync_sample_counter));
  design_1_iq_framer_0_0 iq_framer_0
       (.control({1'b0,1'b0,1'b0,1'b0}),
        .m00_axis_aclk(clk_wiz_0_clk_out1),
        .m00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .m00_axis_tdata(iq_framer_0_M00_AXIS_TDATA),
        .m00_axis_tlast(iq_framer_0_M00_AXIS_TLAST),
        .m00_axis_tready(iq_framer_0_M00_AXIS_TREADY),
        .m00_axis_tstrb(iq_framer_0_M00_AXIS_TSTRB),
        .m00_axis_tvalid(iq_framer_0_M00_AXIS_TVALID),
        .s00_axis_aclk(clk_wiz_0_clk_out1),
        .s00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        ...
        .s01_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
  ...
  design_1_mmio_interface_0_0 mmio_interface_0
       (.command(mmio_interface_0_command),
  ...
  design_1_top_test_0_0 top_test_0
       (.MMIO_thresholds(xpm_cdc_gen_0_dest_out),
        .adc_data_imag(top_test_0_adc_data_imag),
        .adc_data_real(top_test_0_adc_data_real),
        .cb_sample_counter(top_test_0_cb_sample_counter),
        .cb_trigger(top_test_0_cb_trigger),
        .cordic_data_magnitude(top_test_0_cordic_data_magnitude),
        .cordic_magnitude(top_test_0_cordic_magnitude),
        .hsync_counter(top_test_0_hsync_counter),
        .hsync_sample_counter(top_test_0_hsync_sample_counter),
        .hsync_trigger(top_test_0_hsync_trigger),
        .in_cb_range(top_test_0_in_cb_range),
        .in_hsync_range(top_test_0_in_hsync_range),
        .in_vsync_range(top_test_0_in_vsync_range),
        .m00_axis_aclk(clk_wiz_0_clk_out1),
        .m00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .m00_axis_tdata(top_test_0_M00_AXIS_TDATA),
        .m00_axis_tlast(top_test_0_M00_AXIS_TLAST),
        .m00_axis_tready(top_test_0_M00_AXIS_TREADY),
        .m00_axis_tstrb(top_test_0_M00_AXIS_TSTRB),
        .m00_axis_tvalid(top_test_0_M00_AXIS_TVALID),
        .past_hsync_trigger(top_test_0_past_hsync_trigger),
        .s00_axis_aclk(clk_wiz_0_clk_out1),
        .s00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .s00_axis_tdata(iq_framer_0_M00_AXIS_TDATA),
        .s00_axis_tlast(iq_framer_0_M00_AXIS_TLAST),
        .s00_axis_tready(iq_framer_0_M00_AXIS_TREADY),
        .s00_axis_tstrb(iq_framer_0_M00_AXIS_TSTRB),
        .s00_axis_tvalid(iq_framer_0_M00_AXIS_TVALID),
        .state(top_test_0_state),
        .vsync_sample_counter(top_test_0_vsync_sample_counter),
        .vsync_trigger(top_test_0_vsync_trigger));
  design_1_usp_rf_data_converter_0_0 usp_rf_data_converter_0
       (.adc2_clk_n(adc2_clk_clk_n),
        .adc2_clk_p(adc2_clk_clk_p),
        .clk_adc2(clk_wiz_0_clk_out1),
  ...
  design_1_xpm_cdc_gen_0_0 xpm_cdc_gen_0
       (.dest_clk(clk_wiz_0_clk_out1),
        ...
        .src_in(mmio_interface_0_command));
