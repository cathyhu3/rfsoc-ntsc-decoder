...
module design_1
  ...
  wire [31:0]top_0_m00_axis_TDATA;
  wire top_0_m00_axis_TLAST;
  wire top_0_m00_axis_TREADY;
  wire [3:0]top_0_m00_axis_TSTRB;
  wire top_0_m00_axis_TVALID;
  ...
  design_1_axis_data_fifo_0_0 axis_data_fifo_0
       (.m_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_tdata(top_0_m00_axis_TDATA),
        .s_axis_tlast(top_0_m00_axis_TLAST),
        .s_axis_tready(top_0_m00_axis_TREADY),
        .s_axis_tstrb(top_0_m00_axis_TSTRB),
        .s_axis_tvalid(top_0_m00_axis_TVALID));
  ...
  design_1_ila_0_0 ila_0
       (.clk(clk_wiz_0_clk_out1),
        .probe0(top_0_m00_axis_TREADY),
        .probe1(top_0_m00_axis_TDATA),
        .probe2(top_0_m00_axis_TSTRB),
        .probe3(top_0_m00_axis_TVALID),
        .probe4(top_0_m00_axis_TLAST),
        .probe5(1'b0),
  ...
  design_1_ila_2_0 ila_2
       (.clk(clk_wiz_0_clk_out1),
        .probe0(iq_framer_0_M00_AXIS_TREADY),
        .probe1(iq_framer_0_M00_AXIS_TDATA),
        .probe2(iq_framer_0_M00_AXIS_TSTRB),
        .probe3(iq_framer_0_M00_AXIS_TVALID),
        .probe4(iq_framer_0_M00_AXIS_TLAST),
        .probe5(1'b0),
        .probe6({1'b1,1'b1,1'b1,1'b1}),
        .probe7(1'b0),
        .probe8(1'b0));
  ...
  design_1_top_0_0 top_0
       (.MMIO_thresholds(xpm_cdc_gen_0_dest_out),
        .m00_axis_aclk(clk_wiz_0_clk_out1),
        .m00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
        .m00_axis_tdata(top_0_m00_axis_TDATA),
        .m00_axis_tlast(top_0_m00_axis_TLAST),
        .m00_axis_tready(top_0_m00_axis_TREADY),
        .m00_axis_tstrb(top_0_m00_axis_TSTRB),
        .m00_axis_tvalid(top_0_m00_axis_TVALID),
        .s00_axis_aclk(clk_wiz_0_clk_out1),
        .s00_axis_aresetn(proc_sys_reset_1_peripheral_aresetn),
