...
HD_PWD='/home/thagenlo/Desktop/dma_data/rfsoc_proj.runs/design_1_iq_framer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_iq_framer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_iq_framer_0_0.tcl
