...
HD_PWD='/home/thagenlo/Desktop/dma_data/rfsoc_proj.runs/design_1_cic_compiler_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cic_compiler_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cic_compiler_0_1.tcl
