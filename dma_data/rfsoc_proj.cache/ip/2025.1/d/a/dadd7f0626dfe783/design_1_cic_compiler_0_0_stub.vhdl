...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute core_generation_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_cic_compiler_0_0,cic_compiler_v4_0_21,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=cic_compiler,x_ipVersion=4.0,x_ipCoreRevision=21,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_COMPONENT_NAME=design_1_cic_compiler_0_0,C_FILTER_TYPE=1,C_NUM_STAGES=6,C_DIFF_DELAY=1,C_RATE=256,C_INPUT_WIDTH=16,C_OUTPUT_WIDTH=16,C_USE_DSP=1,C_HAS_ROUNDING=0,C_NUM_CHANNELS=1,C_RATE_TYPE=0,C_MIN_RATE=256,C_MAX_RATE=256,C_SAMPLE_FREQ=1,C_CLK_FREQ=1,C_USE_STREAMING_INTERFACE=1,C_FAMILY=zynquplus,C_XDEVICEFAMILY=zynquplus,C_C1=23,C_C2=22,C_C3=21,C_C4=20,C_C5=20,C_C6=19,C_I1=62,C_I2=54,C_I3=46,C_I4=39,C_I5=33,C_I6=26,C_S_AXIS_CONFIG_TDATA_WIDTH=1,C_S_AXIS_DATA_TDATA_WIDTH=16,C_M_AXIS_DATA_TDATA_WIDTH=16,C_M_AXIS_DATA_TUSER_WIDTH=1,C_HAS_DOUT_TREADY=0,C_HAS_ACLKEN=0,C_HAS_ARESETN=0}";
